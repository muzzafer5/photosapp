...
IMPORTANT NOTES:
    ...
    1. If the backend require any database please use any IN-MEMORY or SQLLite database Unless mentioned in  Otherwise .
...
PROJECT START STEPS:
    ...
    2. Go to http://localhost:8080 in your browser to view itQuestions.